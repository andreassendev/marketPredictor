<template>
  <div class="process-page">
    <!-- Top navigation -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">MARKETPREDICTOR</div>
      
      <!-- Step indicator -->
      <div class="nav-center">
        <div class="step-badge">STEP 01</div>
        <div class="step-name">Grafkonstruksjon</div>
      </div>
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          <div class="header-left">
            ...
            <span class="header-title">Sanntids kunnskapsgraf</span>
          </div>
          <div class="header-right">
            <template v-if="graphData">
              <span class="stat-item">{{ graphData.node_count || graphData.nodes?.length || 0 }} noder</span>
              <span class="stat-divider">|</span>
              <span class="stat-item">{{ graphData.edge_count || graphData.edges?.length || 0 }} relasjoner</span>
              <span class="stat-divider">|</span>
            </template>
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph building starts automatically after generation</p>
          </div>
      ...
      <div class="right-panel" :class="{ 'hidden': isFullScreen }">
        ...
        <div class="process-content">
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Ontologigenerering</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After upload, the LLM analyzes document content and auto-generates an ontology structure (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Grafkonstruksjon</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and the Zep API builds a knowledge graph, extracting entities and relations
                </div>
              </div>
        ...
        <div class="project-panel">
          <div class="project-header">
            ...
            <span class="project-title">Prosjektinfo</span>
          </div>
          <div class="project-details" v-if="projectData">
            ...
            <div class="project-item">
              <span class="item-label">Prediction prompt</span>
...
const startBuildGraph = async () => {
  try {
    ...
    error.value = '启动图谱Build failed: ' + (err.message || 'Unknown error')
    buildProgress.value = null
  }
}
...
const fetchGraphData = async () => {
  try {
    // Fetch project info to get graph_id
  ...
  try {
    ...
    if (response.success) {
      ...
      if (task.status === 'completed') {
        console.log('✅ 图谱Build complete，正在加载完整数据...')
        ...
        stopPolling()
        stopGraphPolling()
        error.value = '图谱Build failed: ' + (task.error || 'Unknown error')
        buildProgress.value = null
      }
    }
  } catch (err) {
